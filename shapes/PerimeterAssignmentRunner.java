...
public class PerimeterAssignmentRunner {
    ...
    public double getLargestSide(Shape s) {
        ...
        Point prevPt = s.getLastPoint();
        for (Point i : s.getPoints()) {
            double currDist = prevPt.distance(i);
            if (currDist > largest) {
                largest = currDist;
        }
    }
    ...
    public void testPerimeter () {
        ...
        double averageSide = getAverageLength(s);
    ...
    public void testPerimeterMultipleFiles() {
        ...
        System.out.println("largest perimeter from mutliple files = " + largestPerimeter);
    }

    public void testFileWithLargestPerimeter() {
        String peri = getFileWithLargestPerimeter();
        System.out.println("file with largest perimeter = " + peri);
    }
